...
export function applyPatches(factoryCode: string, ctx: VulpatchCtx, options: acorn.Options = {
    ecmaVersion: "latest"
}) {
    let ast;
...
export function createExpr(exprString: string, options: acorn.Options = {
    ecmaVersion: "latest",
}) {
